var myScrollbar = (function() {
  ...
  function start(config) {
    ...
    _config.content = config.content || "ContArea";
  ...
  function moveContent(e) {
    ...
    if (_config.scrollbar.className === "scrollbar draggable") {
	  ...
	  _config.ScrollTrack = -(_config.scrollbar.top * _config.ratio);
    }
  }

  //A cupple of extensions to the code to handle mouse wheeling.
  function moveup() {
	_config.ScrollTrack += _config.ratio/2;
    _config.scrollbar.top = _config.ScrollTrack;
    ...
    //bottom part of scrollbar to bottom part of scrollbar wrapper
      ...
      _config.scrollbar.top = _config.scrollbarW.offsetHeight - _config.scrollbar.offsetHeight;
	  _config.ScrollTrack = _config.scrollbarW.offsetHeight - _config.scrollbar.offsetHeight;
    }
